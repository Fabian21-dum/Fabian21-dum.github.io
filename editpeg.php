...
{	
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE pegawai SET nama='$name', uname='$uname', pas='$pass' WHERE id=$id");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">ID Pegawai</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" name="password" value=<?php echo $pass;?> class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                        <button type="submit" name="update" class="mt-4 btn btn-dark d-flex justify-content-center align-items-center" name="regis">Update Data Pegawai</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
