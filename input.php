...
$jumlah_anggota=mysqli_query($mysqli,"SELECT COUNT(*) as id from admin");
                                ...
                                <form method="POST" class="form-horizontal form-material" >
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="nama_brg" placeholder="Indomie"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="username" class="col-md-12 p-0">Jumlah Barang</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="jumlah" placeholder="69"
                                    ...
                                    <div class="form-group">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="date" class="form-control" type="date" id="receiving_date" value="<?php echo $today; ?>" required
                                                class="input-xlarge"/>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                        <button type="submit" name="Submit" class="mt-4 btn btn-dark d-flex justify-content-center align-items-center" name="regis">Tambah Barang</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO barang(nama_barang,jumlah,tanggal_input) VALUES('$name','$jumlah','$date')") or die(mysql_error());
    
    // Show message when user added
    echo "Barang Telah Diinput. ";
