        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="dashpeg.php" class="fw-normal">Dashboard</a></li>
                            </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="card-body">
                  ...
                  <a href="input.php"><button class='btn btn-primary px-2'>Tambah Barang</button></a><br/><br/>
                    ...
                    <table class="table">
                      ...
                      <?php  
                        while($user_data = mysqli_fetch_array($result)) {         
                            ...
                            echo "<td><a href='edit.php?id=$user_data[id]'><button class='btn btn-success text-white'>Edit</button></a> | <a href='delete.php?id=$user_data[id]'><button class='btn btn-danger text-white'>Hapus</button></a></td></tr>";        
                            }
                        ?>
                      </tbody>
                    </table>
