    ...
    <div class="d-flex flex row g-0">
        <div class="col-md-6 mt-3">
            <div class="card card1 p-3">
                <div class="d-flex flex-column"> <img src="img/gudang.png" height="50" width="50" /> <span class="login mt-3">Log in Pegawai</span> </div>
                ...
                <a href="log.php " class="mt-4 ms-auto me-auto">Login Sebagai Admin</a>
                </div>
            </div>SS
        </div>
        <div class="col-md-6 mt-3">
            ...
            <?php
                if(isset($_POST['log'])){
                    if(!empty($_POST['username']) && !empty($_POST['password'])){
                        ...
                        $query=mysqli_query($mysqli, "SELECT * FROM pegawai WHERE uname='$username'AND pas='$password'");
                        ...
                        if($numrows>0)
                        {
                            ...
                            echo "<p><center>Gagal Masuk Sebagai Pegawai</center></p>";
                            echo   "</div>";
                            echo "</div>";
                        }
                    }else{
